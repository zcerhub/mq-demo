...
import static com.example.mqotel.ProduceDemo.MQ_OTEL_TEST_NAMESERVER;
import static com.example.mqotel.ProduceDemo.MQ_OTEL_TEST_TOPIC;

public class PushConsumer {

    public static void main(String[] args) throws InterruptedException, MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("mq-otel-push-consumer",true);
        consumer.setNamesrvAddr(MQ_OTEL_TEST_NAMESERVER);
        consumer.subscribe(MQ_OTEL_TEST_TOPIC, "*");
